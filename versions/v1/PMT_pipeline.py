...
#os.system('source /sbnd/app/users/brindenc/miniconda3/bin/activate') #Activate conda enviroment for imports
#os.system('conda activate base')
#os.system('source /sbnd/app/users/brindenc/bash_scripts/activate_conda.sh')
...
#os.system('python -V')
os.system(f'python3.9 PMT_analyze_fit.py -f {file_path}') #Run python
os.chdir('read_model')
